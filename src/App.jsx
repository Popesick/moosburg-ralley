...
const STATIONS = [
  ...
  },
  {
    ...
    code: "gedenkplatz789",
    question: "Eure Reise führt euch nun zu einem Ort des Erinnerns.\n\nHier steht der „Gedenkbrunnen“, im Volksmund als „Franzosenbrunnen“ bekannt, ein vom französischen Bildhauer Antoniucci Volti im Stalag VII A gestalteter und gefertigter Brunnenstein mit einem Rundumrelief, das die 4 großen Flüsse Frankreichs allegorisch darstellt\n\nDas Bild hilft euch den QR-Code zu finden.",
    infoText: "Zentraler Erinnerungsort oder Gedenkort auf dem Gelände des ehemaligen Lagerlazarettes ist der Stalag-Gedenkplatz mit dem Gedenkbrunnen (sog. "Franzosenbrunnen") und Informationstafeln. \n\nDer Brunnen wurde vom französischen Bildhauer Antoniucci Volti während seiner Gefangenschaft gestaltet und gefertigt. Der Brunnenstein zeigt vier allegorische Darstellungen der wichtigsten französichen Flüsse. \n\nEr wurde im Jahre 1963 als erstes Denkmal zum Gedenken an die französischen Kriegsgefangenen im Stalag VII A aufgestellt und eingeweiht. Im Jahr 2015 wurde der Platz neu gestaltet und zum Gedenken an alle Kriegsgefangenen umgewidmet. \n\nHier findet jedes Jahr zum Befreiungstag am 29. April eine Gedenkzeremonie mit Kranzniederlegungenstatt."
  },
  {
    id: 3,
